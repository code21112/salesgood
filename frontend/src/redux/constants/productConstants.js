...
export const GET_MAXPRICE_REQUEST = 'GET_MAXPRICE_REQUEST';
export const GET_MAXPRICE_SUCCESS = 'GET_MAXPRICE_SUCCESS';
export const GET_MAXPRICE_FAIL = 'GET_MAXPRICE_FAIL';
