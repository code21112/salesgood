...
// GET Max Price ==> /api/v1/products/maxPrice
exports.getMaxPrice = catchAsyncErrors(async (req, res, next) => {

    const products = await Product.find();
    const findMaxPrice = (products) => {
        const max = products.sort((a, b) => b.price - a.price)[0];
...
// POST Adding a product ==> /api/v1/product/new
...
// PUT Update a single product ==> /api/v1/admin/product/:id
exports.updateProduct = catchAsyncErrors(async (req, res, next) => {
    ...
    if (images !== undefined) {
        // Deleting the images associated with the product
...
// DELETE delete a product (admin) ==> /api/v1/admin/product/:id
